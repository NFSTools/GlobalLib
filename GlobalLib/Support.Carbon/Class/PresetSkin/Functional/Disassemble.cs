namespace GlobalLib.Support.Carbon.Class
{
    public partial class PresetSkin
    {
        ...
        protected override unsafe void Disassemble(byte* byteptr_t)
        {
            ...
            // Paint Swatch
            this.PaintSwatch = Utils.EA.Resolve.GetSwatchIndex(Core.Map.Lookup(*(uint*)(byteptr_t + 0x2C), false));
            ...
            this._genericvinyl = Core.Map.Lookup(key, true) ?? $"0x{key:X8}";
            ...
            this.SwatchColor1 = Utils.EA.Resolve.GetSwatchIndex(Core.Map.Lookup(*(uint*)(byteptr_t + 0x48), false));
            this.SwatchColor2 = Utils.EA.Resolve.GetSwatchIndex(Core.Map.Lookup(*(uint*)(byteptr_t + 0x50), false));
            this.SwatchColor3 = Utils.EA.Resolve.GetSwatchIndex(Core.Map.Lookup(*(uint*)(byteptr_t + 0x58), false));
            this.SwatchColor4 = Utils.EA.Resolve.GetSwatchIndex(Core.Map.Lookup(*(uint*)(byteptr_t + 0x60), false));
