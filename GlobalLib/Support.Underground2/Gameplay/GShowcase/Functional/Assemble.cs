namespace GlobalLib.Support.Underground2.Gameplay
{
	public partial class GShowcase
	{
		public unsafe void Assemble(byte* byteptr_t, Utils.MemoryWriter mw)
		{
			...
			*(uint*)(byteptr_t + 0x28) = Utils.Bin.SmartHash(this.DescStringLabel);
			*(uint*)(byteptr_t + 0x2C) = Utils.Bin.SmartHash(this.DestinationPoint);
			*(byteptr_t + 0x34) = this.Unknown0x34;
			*(byteptr_t + 0x35) = this.Unknown0x35;
			*(uint*)(byteptr_t + 0x38) = Utils.Bin.SmartHash(this.DescAttrib);
