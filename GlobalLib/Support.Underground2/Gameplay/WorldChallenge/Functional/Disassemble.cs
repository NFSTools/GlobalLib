namespace GlobalLib.Support.Underground2.Gameplay
{
	public partial class WorldChallenge
	{
		protected unsafe void Disassemble(byte* ptr_header, byte* ptr_string)
		{
			...
			this.UseOutrunsAsReqRaces = (*(ptr_header + 6) == 2) ? Reflection.Enum.eBoolean.True : Reflection.Enum.eBoolean.False;
			...
			this.WorldChallengeType = (Reflection.Enum.eWorldChallengeType)(*(ptr_header + 0x14));
